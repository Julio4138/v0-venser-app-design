        ...
        <Card className="p-6 border-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <Link href="/admin/community">
              <Card className="p-6 hover:shadow-xl transition-all cursor-pointer border-2 hover:border-pink-500 group h-full">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-1">Gerenciar Comunidade</h4>
                    <p className="text-sm text-muted-foreground">
            ...
            <Link href="/admin/pesquisa">
              <Card className="p-6 hover:shadow-xl transition-all cursor-pointer border-2 hover:border-blue-500 group h-full">
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-1">Artigos de Pesquisa</h4>
                    <p className="text-sm text-muted-foreground">
                      Gerencie artigos e pesquisas científicas sobre pornografia
                    </p>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-blue-600 font-medium">
                    <span>Acessar</span>
            ...
            <Link href="/admin/podcast">
              <Card className="p-6 hover:shadow-xl transition-all cursor-pointer border-2 hover:border-blue-500 group h-full">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-blue-500 via-blue-400 to-blue-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                      <Music className="h-7 w-7 text-white" />
                    </div>
                    <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-blue-500 group-hover:translate-x-1 transition-all" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-lg mb-1">Podcasts</h4>
                    <p className="text-sm text-muted-foreground">
                      Gerencie áudios e vídeos de podcasts para os usuários
                    </p>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-blue-600 font-medium">
                    <span>Acessar</span>
            ...
            <Link href="/admin/playlist">
              <Card className="p-6 hover:shadow-xl transition-all cursor-pointer border-2 hover:border-indigo-500 group h-full">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-indigo-500 via-indigo-400 to-indigo-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-1">Playlists</h4>
                    <p className="text-sm text-muted-foreground">
                      Crie e gerencie playlists de podcasts organizadas
                    </p>
                  </div>
