...
export default function ProgramPage() {
  ...
  const weeks = []
  // Usar selectedDuration diretamente para filtrar os dias exibidos
  const totalDays = selectedDuration || 90
      ...
      <div className={cn(collapsed ? "md:ml-20 lg:ml-20" : "md:ml-56 lg:ml-64", "relative z-10")}>
        <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pt-20 md:pt-8 py-6 md:py-8 space-y-6 md:space-y-8 pb-20 md:pb-8 relative z-10">
                    ...
                    {programDurations.map((duration) => (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          setSelectedDay(null) // Limpar seleção de dia ao mudar duração
                        }}
                        className={cn(
                          "transition-all",
          ...
          {selectedDay ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-3 md:gap-4">
                    <DayCard
                      ...
                      day={selectedDay}
                      status={dayStatus}
                      streak={dayStatus === "current" && userProgress.currentStreak >= 7}
            ...
            // Mostrar todos os dias quando nenhum está selecionado
            weeks.map((week) => (
